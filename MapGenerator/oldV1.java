...
public class StreamRandom implements IMap {
	...
	public StreamRandom(String pathMidi,String pathMp3, double BPM) throws Exception {
	...
	public String hitObjects() {
		...
		try {
			...
			for(int i=2;i<sortedMidiEvents.size()-1;i++) {
				...
				if(rythmNext<=2 && rythmPrevious<=2true ) {
